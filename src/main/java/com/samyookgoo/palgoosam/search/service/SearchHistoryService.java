...
public class SearchHistoryService {
    ...
    public List<SearchHistoryResponseDto> getSearchHistory() {
        ...
        return searchHistoryList.stream().map(searchHistory ->
                SearchHistoryResponseDto.builder().id(searchHistory.getId()).keyword(searchHistory.getKeyword())
                        .createdAt(searchHistory.getCreatedAt()).updatedAt(searchHistory.getUpdatedAt())
                        .build()).toList();
    }
